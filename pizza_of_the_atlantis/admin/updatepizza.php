...
if(isset($_POST['done']))
{
    ...
    if(isset($_FILES['pizzaimage-u']) && !empty($_FILES['pizzaimage-u']['name']))
    {
    	if($_FILES['pizzaimage-u']['type']=="image/png" || $_FILES['pizzaimage-u']['type']=="image/jpg" || $_FILES['pizzaimage-u']['type']=="image/jpeg")
    	{
    		$dp="img_".time()."_".$_FILES['pizzaimage-u']['name'];
    		$target.=basename($dp);
    		move_uploaded_file($_FILES['pizzaimage-u']['tmp_name'],$target);
    	}
    	else
    	{
    ...
    {
    	unlink($disp['image']);
        $query2="UPDATE pizza SET name='$name',description='$description',image='$target',small_price='$small_price',medium_price='$medium_price',large_price='$large_price' WHERE id='$id'";
				...
				<div class="container">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark">Edit Pizza</h5>
						</div>
													...
													<div class="col-md-2">
														<div class="form-group">
															...
															<div class="input-group">
																...
																<input name="small_price" type="text" class="form-control" value="<?php echo $disp['small_price']; ?>" required>
															</div>
														</div>
													</div>
													<div class="col-md-2">
														<div class="form-group">
															...
															<div class="input-group">
																<div class="input-group-addon"><i class="ti-money"></i></div>
																<input name="medium_price" type="text" class="form-control" value="<?php echo $disp['medium_price']; ?>"required>
															</div>
														</div>
													</div>
													<div class="col-md-2">
														<div class="form-group">
															...
															<div class="input-group">
																<div class="input-group-addon"><i class="ti-money"></i></div>
																<input name="large_price" type="text" class="form-control" value="<?php echo $disp['large_price']; ?>" required>
															</div>
														</div>
													</div>
												...
												<div class="row">
													<div class="col-lg-12">
														...
														<div class="fileupload btn btn-info btn-anim"><i class="fa fa-upload"></i><span class="btn-text">Upload new image</span>
															<input name="pizzaimage-u" id="pizzaimage-u" type="file" class="upload" required>
														</div>
													</div>
												</div>
												<div class="seprator-block"></div>
