...
if(isset($_POST['done']))
{
    ...
    if(isset($_FILES['image-u']) && !empty($_FILES['image-u']['name']))
    {
    	if($_FILES['image-u']['type']=="image/png" || $_FILES['image-u']['type']=="image/jpg" || $_FILES['image-u']['type']=="image/jpeg")
    	{
    		$dp="img_".time()."_".$_FILES['image-u']['name'];
    		$target.=basename($dp);
    		move_uploaded_file($_FILES['image-u']['tmp_name'],$target);
    	}
    	else
    	{
    ...
    {
    	unlink($disp['image']);
        $query2="UPDATE breverage SET name='$name',image='$target',small_price='$small_price',half_litre_price='$half_litre_price' WHERE id='$id'";
				...
				<div class="container">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark">Edit Breverage</h5>
						</div>
												...
												<div class="row">
													...
													<div class="col-md-3">
														<div class="form-group">
															...
															<div class="input-group">
																<div class="input-group-addon"><i class="ti-money"></i></div>
																<input name="half_litre_price" type="text" class="form-control" value="<?php echo $disp['half_litre_price']; ?>" required>
															</div>
														</div>
													</div>
												...
												<div class="row">
													<div class="col-lg-12">
														...
														<div class="fileupload btn btn-info btn-anim"><i class="fa fa-upload"></i><span class="btn-text">Upload new image</span>
															<input type="file" name="image-u" id="image-u"class="upload" required>
														</div>
													</div>
												</div>
												<div class="seprator-block"></div>
