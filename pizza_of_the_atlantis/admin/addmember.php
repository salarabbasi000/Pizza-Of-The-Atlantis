...
if(isset($_POST['done']))
{
    ...
    if(isset($_FILES['memberimage']) && !empty($_FILES['memberimage']['name']))
    {
    	if($_FILES['memberimage']['type']=="image/png" || $_FILES['memberimage']['type']=="image/jpg" || $_FILES['memberimage']['type']=="image/jpeg")
    	{
    		$dp="img_".time()."_".$_FILES['memberimage']['name'];
    		$target.=basename($dp);
    		move_uploaded_file($_FILES['memberimage']['tmp_name'],$target);
    	}
    	else
    	{
    ...
    if($exec->num_rows==0 || $position!='Founder')
    {
        $query2="INSERT INTO team (name,position,description,image,facebook,instagram) VALUES ('$name','$position','$description','$target','$facebook','$instagram')";
				...
				<div class="container">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark">Add Team Member</h5>
						</div>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" class="form-control" placeholder="Facebook Profile Link" name="facebook">
														</div>
													</div>
													<!--/span-->
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" class="form-control" placeholder="Instagram Profile Link" name="instagram">
														</div>
													</div>
												</div>
												<!--/row-->
												...
												<div class="row">
													<div class="col-lg-12">
														...
														<div class="fileupload btn btn-info btn-anim"><i class="fa fa-upload"></i><span class="btn-text">Upload new image</span>
															<input name="memberimage" id="memberimage" type="file" class="upload" required>
														</div>
													</div>
												</div>
												<div class="seprator-block"></div>
