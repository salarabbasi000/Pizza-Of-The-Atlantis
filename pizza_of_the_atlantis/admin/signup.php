		...
		<div class="wrapper  pa-0">
			<header class="sp-header">
				<div class="sp-logo-wrap pull-left">
					<a href="index.html">
						<img class="brand-img mr-10" src="../img/logo1.png" alt="brand"/>
						<span class="brand-text">Pizza Of The Atlantis</span>
					</a>
				</div>
				<div class="form-group mb-0 pull-right">
					<span class="inline-block pr-10 txt-light-grey">Already have an account?</span>
					<a class="inline-block btn btn-warning btn-rounded" href="login.php">Sign In</a>
				</div>
							...
							<div class="auth-form  ml-auto mr-auto no-float card-view pt-30 pb-30">
								<div class="row">
									<div class="col-sm-12 col-xs-12">
										<div class="mb-30">
											<h3 class="text-center txt-dark mb-10">Sign up to Admin Panel</h3>
										...
										<div class="form-wrap">
											<form method="post">
												<div class="form-group">
													...
													<input name="name" type="email" class="form-control" required="" id="exampleInputName_1" placeholder="Username">
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<input name="cpassword" type="password" class="form-control" required="" id="exampleInputpwd_3" placeholder="Enter pwd">
												</div>
												<!-- <div class="form-group">
