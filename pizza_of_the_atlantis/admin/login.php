...
<html lang="en">
	<head>
		...
		<title>I Fast build Admin dashboard for any platform</title>
							...
							<div class="auth-form  ml-auto mr-auto no-float card-view pt-30 pb-30">
								<div class="row">
									<div class="col-sm-12 col-xs-12">
										<div class="mb-30">
											<h3 class="text-center txt-dark mb-10">Sign in as Admin</h3>
										...
										<div class="form-wrap">
											<form action="../php/loginscript.php" method="post">
												...
												<div class="form-group text-center">
													<button name="login" type="submit" class="btn btn-warning  btn-rounded">sign in</button>
												</div>
											</form>
										</div>
									</div>	
