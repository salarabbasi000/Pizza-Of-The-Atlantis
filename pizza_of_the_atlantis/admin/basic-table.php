			...
			<div class="page-wrapper">
				<div class="container">
					...
					<div class="row heading-bg">
						...
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
							<ol class="breadcrumb">
								...
								<li class="active"><span>Team Members Info</span></li>
							</ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
					...
					<div class="row">
						...
						function color($c)
						{
							if($c=="Founder") return("primary");
							if($c=="Manager") return("success");
							if($c=="Cashier") return("warning");
							if($c=="Cook") return("danger");
							if($c=="Chef") return("info");
						}



						$q=$con->query("SELECT * FROM team");
						while($row=mysqli_fetch_array($q))
						{
						?>	

						<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
							<div class="panel panel-<?php echo color($row['position']); ?> contact-card card-view">
								<div class="panel-heading">
									...
									<div class="pull-right">
										<a class="pull-left inline-block mr-15" href="updatemember.php?id=<?php echo $row['id']; ?>" >
											<i class="zmdi zmdi-edit txt-light"></i>
										</a>
										<a class="pull-left inline-block mr-15" href="../php/deleteteam.php?id=<?php echo $row['id']; ?>" >
									...
									<div class="panel-body row">
										<div class="user-others-details pl-15 pr-15">
											<!-- <div class="mb-15">
												...
												<span class="inline-block txt-dark">xyz@yahoo.com</span>
											</div>
											<div class="mb-15">
											...
											<div class="mb-15">
												<i class="zmdi zmdi-facebook inline-block mr-10"></i>
												<span class="inline-block txt-dark"><?php echo $row['facebook']; ?></span>
											</div>
											<div>	
												<i class="zmdi zmdi-instagram inline-block mr-10"></i>
												<span class="inline-block txt-dark"><?php echo $row['instagram']; ?></span>
											</div>
										</div>
