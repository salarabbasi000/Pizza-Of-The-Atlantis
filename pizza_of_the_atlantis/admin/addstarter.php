...
if(isset($_POST['done']))
{
    ...
    if(isset($_FILES['starterimage']) && !empty($_FILES['starterimage']['name']))
    {
    	if($_FILES['starterimage']['type']=="image/png" || $_FILES['starterimage']['type']=="image/jpg" || $_FILES['starterimage']['type']=="image/jpeg")
    	{
    		$dp="img_".time()."_".$_FILES['starterimage']['name'];
    		$target.=basename($dp);
    		move_uploaded_file($_FILES['starterimage']['tmp_name'],$target);
    	}
    	else
    	{
    ...
    if($exec->num_rows==0)
    {
        $query2="INSERT INTO starter (name,description,image,pieces_or_servings,price) VALUES ('$name','$description','$target','$pieces_or_servings','$price')";
				...
				<div class="container">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark">Add Starter</h5>
						</div>
													...
													<div class="col-md-4">
														<div class="form-group">
															...
															<div class="input-group">
																...
																<input name="pieces_or_servings" type="number" class="form-control" required>
															</div>
														</div>
													</div>
													<!--/span-->
												...
												<div class="row">
													<div class="col-lg-12">
														...
														<div class="fileupload btn btn-info btn-anim"><i class="fa fa-upload"></i><span class="btn-text">Upload new image</span>
															<input name="starterimage" id="starterimage" type="file" class="upload" required>
														</div>
													</div>
												</div>
												<div class="seprator-block"></div>
