...
<body>
    ...
    <div class="page-title-img">
        <img class="img-full" alt="page title img" src="pictures/banners/contact.jpg">
        <div class="page-title">
            <!-- <div class="container">
                <h1 style="color: white">Give Your Message</h1>
                <p style="color: white">Also Find Our Location!</p>
            </div> --><!-- .container -->
        </div>
    </div><!-- .page-title-img -->
    ...
    <section>
    	<div class="container">
            ...
            <div class="row">
            	<div class="col-md-8">
                    <h3 class="text-uppercase">Give Your Feedback!</h3>

                    <form  method="post" action="insertfeedback.php">
                        <div class="row">
                        	<div class="col-sm-6">
                        	<input type="text" name="name" placeholder="Your Name" required <?php if(isset($_SESSION['abc'])) { ?> value="<?php echo $account['name'] ?>" readonly <?php } ?> >
                        	</div>
                            <div class="col-sm-6">
                        	<input type="email" name="email" placeholder="Your Email" required <?php if(isset($_SESSION['abc'])) { ?> value="<?php echo $account['email'] ?>" readonly <?php } ?> >
                        	</div>
                       	</div>
                        ...
                        <div class="text-right">
                            <input class="button-yellow button-text-low button-long button-low" type="submit" name="done" value="Submit">
                        </div>
                    </form>
            ...
            <h3 class="text-center text-uppercase">Our Location</h3>
            <div class="map-container">
                <!-- <div id="map-canvas">
                </div> -->
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d904.51638946699!2d67.1163260291825!3d24.929836499001336!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3eb338c016b11227%3A0x1bc8a2ce438eb21f!2sBell+Arcade+Gulistan-e-Johar%2C+Service+Lane%2C+Block+1+Gulistan-e-Johar%2C+Karachi%2C+Karachi+City%2C+Sindh%2C+Pakistan!5e0!3m2!1sen!2s!4v1530373063796" width="100%" height="600" frameborder="0" style="border:0" allowfullscreen></iframe>
