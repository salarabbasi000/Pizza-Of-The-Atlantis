...
<head>
    ...
    <link rel="stylesheet" href="assets/styles/animate.min.css" type="text/css">
    <link rel="stylesheet" href="assets/styles/main.css" type="text/css">
    <link rel="stylesheet" href="assets/styles/white.css" type="text/css">
...
<body>
    ...
    <section id="section-intro">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                	<a href="#">
                        <article class="banner onscroll-animate" data-animation="fadeInLeft">
                ...
                <div class="col-md-6">
                	<a href="#">
                        <article class="banner onscroll-animate" data-animation="fadeInRight">
            ...
            <div class="row">
                <div class="col-sm-6 responsive-column">
                    <div class="row">
                        <div class="col-md-6 responsive-column">
                            <div class="icon-box">
                                <div class="icon-box-inner onscroll-animate" data-animation="fadeInUp">
                                ...
                                <h3 class="bottom-line"><a href="#">Pizza Slices</a></h3>
                        ...
                        <div class="col-md-6 responsive-column">
                            <div class="icon-box">
                                <div class="icon-box-inner onscroll-animate" data-animation="fadeInUp" data-delay="300">
                                    <div class="icon-box-icon">
                                ...
                                <h3 class="bottom-line"><a href="#">Tomato CSS</a></h3>
                                When gliding by the Bashee isles we emerged at last upon the great South Sea, were it not for other things, I could have greeted.
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-6 responsive-column">
                    <div class="row">
                        <div class="col-md-6 responsive-column">
                            <div class="icon-box">
                                <div class="icon-box-inner onscroll-animate" data-animation="fadeInUp" data-delay="400">
                                    <div class="icon-box-icon">
                                ...
                                <h3 class="bottom-line"><a href="#">Mushroom HTML</a></h3>
                                When gliding by the Bashee isles we emerged at last upon the great South Sea, were it not for other things, I could have greeted.
                            </div>
                        </div>
                        <div class="col-md-6 responsive-column">
                            <div class="icon-box">
                                <div class="icon-box-inner onscroll-animate" data-animation="fadeInUp" data-delay="500">
                                    <div class="icon-box-icon">
                                ...
                                <h3 class="bottom-line"><a href="#">Olives</a></h3>
                                When gliding by the Bashee isles we emerged at last upon the great South Sea, were it not for other things, I could have greeted.
                            </div>
                        </div>
                    </div>
    ...
    <section class="heavy-borders bg-black-cover1 section-video bg-pattern2">
    	<div id="video-main-play" class="icon-video onscroll-animate"></div>
		<iframe id="video-main" src="http://www.youtube.com/embed/tDvBwPzJ7dY?enablejsapi=1&amp;html5=1" allowfullscreen></iframe>
    </section>
    ...
    <section id="section-about">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 onscroll-animate" data-animation="fadeInLeft">
                    <h2>Our History</h2>
                ...
                <div class="col-md-6 onscroll-animate" data-animation="fadeInRight">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="row">
                        ...
                        <div class="col-sm-6 onscroll-animate" data-animation="fadeInUp" data-delay="300">
                            <div class="worker">
                            	<div class="worker-head">
                ...
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-sm-6 onscroll-animate" data-animation="fadeInUp" data-delay="400">
                            <div class="worker">
                            	<div class="worker-head">
                                    <div class="worker-img">
                                        <div class="worker-img-layer-1">
                        ...
                        <div class="col-sm-6 onscroll-animate" data-animation="fadeInUp" data-delay="500">
                            <div class="worker">
                            	<div class="worker-head">
                                    <div class="worker-img-alt">
                                        <div class="worker-img-layer-1">
    ...
    <section id="section-menu">
        <div class="container">
            ...
            <div class="onscroll-animate">
                <div id="menu-slider">
                    <div class="product-preview product-detail-trigger active" data-product-detail="#product-1-detail">
                    ...
                    <div class="product-preview product-detail-trigger" data-product-detail="#product-2-detail">
                        <div class="product-preview-inner">
                            <div class="product-photo">
                                <div class="product-price">
                    ...
                    <div class="product-preview product-detail-trigger" data-product-detail="#product-3-detail">
                        <div class="product-preview-inner">
                            <div class="product-photo">
                                <div class="product-price">
                                    <sub>$</sub>8.<sup>99</sup>
                                </div>
            ...
            <div id="product-details" class="product-details onscroll-animate">
                <div id="product-1-detail" class="product-detail">
                	<form>
                    	<input type="hidden" name="product-name" value="product1 name">
                        <div class="row">
                            <div class="col-lg-3 col-md-8">
                                <div class="product-detail-left">
                                	<h4 class="text-uppercase no-top-margin">Vegetarian</h4>
                                    <span class="text-uppercase">Ingredients:</span><br>
                                    <em>Pepperoni, Cascioppo Bros. Italian sausage, Ostrom's mushrooms, olives, green peppers, onions and mozzarella over our seasoned tomato sauce.</em>
                                    <div class="margin-30"></div>
                                    <a class="button-yellow with-right-arrow form-submit-trigger">Order now</a>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-4">
                                <div class="product-detail-middle">
                                    <span class="text-uppercase">select size:</span>
                                    <label class="product-size">
                                    	<input type="radio" name="product-size" value="small">
                                    ...
                                    <label class="product-size">
                                    	<input type="radio" name="product-size" value="medium" checked>
                                        <span class="product-size-img">
                                    ...
                                    <label class="product-size">
                                    	<input type="radio" name="product-size" value="medium">
                                        <span class="product-size-img">
                    ...
                    <a class="product-detail-img" href="assets/images/products/detail1.jpg" data-lightbox="product-1" style="background-image:url('assets/images/products/detail1.jpg')">
                        <img alt="product detail" src="assets/images/products/detail1.jpg">
                    </a>
                </div><!-- #product-1-detail -->
                <div id="product-2-detail" class="product-detail">
                	<form>
                    	<input type="hidden" name="product-name" value="product2 name">
                        <div class="row">
                            <div class="col-lg-3 col-md-8">
                                <div class="product-detail-left">
                                	<h4 class="text-uppercase no-top-margin">Mushroom Lovers</h4>
                                    <span class="text-uppercase">Ingredients:</span><br>
                                    <em>Pepperoni, Cascioppo Bros. Italian sausage, Ostrom's mushrooms, olives, green peppers, onions and mozzarella over our seasoned tomato sauce.</em>
                                    <div class="margin-30"></div>
                                    <a class="button-yellow with-right-arrow form-submit-trigger">Order now</a>
                    ...
                    <a class="product-detail-img" href="assets/images/products/detail2.jpg" data-lightbox="product-2" style="background-image:url('assets/images/products/detail2.jpg')">
                        <img alt="product detail" src="assets/images/products/detail2.jpg">
                    </a>
                </div><!-- #product-2-detail -->
                <div id="product-3-detail" class="product-detail">
                	<form>
                    	<input type="hidden" name="product-name" value="product3 name">
                        <div class="row">
                            <div class="col-lg-3 col-md-8">
                                <div class="product-detail-left">
                                	<h4 class="text-uppercase no-top-margin">Pepperoni Burner</h4>
                                    <span class="text-uppercase">Ingredients:</span><br>
                                    <em>Pepperoni, Cascioppo Bros. Italian sausage, Ostrom's mushrooms, olives, green peppers, onions and mozzarella over our seasoned tomato sauce.</em>
                                    <div class="margin-30"></div>
                                    <a class="button-yellow with-right-arrow form-submit-trigger">Order now</a>
                    ...
                    <a class="product-detail-img" href="assets/images/products/detail3.jpg" data-lightbox="product-3" style="background-image:url('assets/images/products/detail3.jpg')">
                        <img alt="product detail" src="assets/images/products/detail3.jpg">
                    </a>
                </div><!-- #product-3-detail -->
            </div><!-- .product-details -->
            
            <p class="text-center">
            	<a href="menu_1.html" class="button-void button-long onscroll-animate" data-animation="flipInY">SEE FULL MENU</a>
        	</p>
        </div><!-- .container -->
    </section><!-- #section-menu -->
    
    <section class="section-testimonials heavy-borders bg-black-cover2 parallax-background">
    	<div class="container bg-delivery">
                    ...
                    <div id="testimonial-slider">
                        <div class="testimonial">
                            ...
                            <div class="testimonial-image">
                                <img alt="author" src="assets/images/avatars/1.png">
                            </div>
                            <div class="testimonial-detail">
                                Dieter Rams | <em>Ceo at doing things</em>
                            </div>
                        </div><!-- .testimonial -->
                        <div class="testimonial">
                            Good design is making something intelligible and memorable. Great design is making something memorable and meaningful.
    ...
    <section id="section-gallery">
    	<div class="container">
            ...
            <p class="text-center"><em>When gliding by the Bashee isles we emerged at last upon the great South Sea.</em></p>
           	<div class="text-center onscroll-animate" data-animation="fadeInDown" data-delay="300">
            	Filter:
            ...
            <div class="onscroll-animate" data-animation="fadeInUp">
                <div id="gallery" class="gallery row">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 gallery-item filter-pizza filter-sandwiches filter-wordpress">
                        <img alt="photo" src="assets/images/gallery/gallery5.jpg">
                        <div class="gallery-item-detail">
                            <div class="text-right">
                                <a href="assets/images/gallery/gallery5.jpg" class="gallery-detail-icon" data-lightbox="gallery-images"><i class="fa fa-search"></i></a>
                                <a href="#" class="gallery-detail-icon"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div><!-- .gallery-item -->
                    <div class="col-md-3 col-sm-6 col-xs-12 gallery-item dark-cover filter-sandwiches filter-wordpress">
                        <img alt="photo" src="assets/images/gallery/gallery6.jpg">
                        <div class="gallery-item-detail">
                            <div class="text-center">
                                <p>
                                    <a href="assets/images/gallery/gallery6.jpg" class="gallery-detail-icon" data-lightbox="gallery-images"><i class="fa fa-search"></i></a>
                                    <a href="#" class="gallery-detail-icon"><i class="fa fa-expand"></i></a>
                                </p>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 gallery-item filter-pizza filter-photoshop">
                        <img alt="photo" src="assets/images/gallery/gallery1.jpg">
                        <div class="gallery-item-detail">
                            <div class="row">
                                ...
                                <div class="col-sm-5 text-right">
                                    <a href="assets/images/gallery/gallery1.jpg" class="gallery-detail-icon" data-lightbox="gallery-images"><i class="fa fa-search"></i></a>
                                    <a href="#" class="gallery-detail-icon"><i class="fa fa-expand"></i></a>
                                </div>
                            </div>
                        </div>
                    </div><!-- .gallery-item -->
                    <div class="col-md-6 col-sm-6 col-xs-12 gallery-item filter-hamburgers filter-photoshop">
                        <img alt="photo" src="assets/images/gallery/gallery2.jpg">
                        <div class="gallery-item-detail">
                            <div class="row">
                                <div class="col-sm-7 hidden-xs">
                                    <h4 class="gallery-item-heading">HOT PEPPERONI</h4>
                                ...
                                <div class="col-sm-5 text-right">
                                    <a href="assets/images/gallery/gallery2.jpg" class="gallery-detail-icon" data-lightbox="gallery-images"><i class="fa fa-search"></i></a>
                                    <a href="#" class="gallery-detail-icon"><i class="fa fa-expand"></i></a>
                                </div>
                            </div>
                        </div>
                    </div><!-- .gallery-item -->
                    <div class="col-md-3 col-sm-6 col-xs-12 gallery-item dark-cover filter-pizza filter-sandwiches filter-hamburgers">
                        <img alt="photo" src="assets/images/gallery/gallery3.jpg">
                        <div class="gallery-item-detail">
                            <div class="text-center">
                                <p>
                                    <a href="assets/images/gallery/gallery3.jpg" class="gallery-detail-icon" data-lightbox="gallery-images"><i class="fa fa-search"></i></a>
                                    <a href="#" class="gallery-detail-icon"><i class="fa fa-expand"></i></a>
                                </p>
                                <h4 class="gallery-item-heading">HOT PEPPERONI</h4>
                                pizza, salads, design
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 gallery-item filter-sandwiches filter-photoshop">
                        <img alt="photo" src="assets/images/gallery/gallery4.jpg">
                        <div class="gallery-item-detail">
                            <div class="text-right">
                                <a href="assets/images/gallery/gallery4.jpg" class="gallery-detail-icon" data-lightbox="gallery-images"><i class="fa fa-search"></i></a>
                                <a href="#" class="gallery-detail-icon"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div><!-- .gallery-item -->
                    <div class="col-md-3 col-sm-6 col-xs-12 gallery-item dark-cover filter-pizza filter-photoshop">
                        <img alt="photo" src="assets/images/gallery/gallery7.jpg">
                        <div class="gallery-item-detail">
                            <div class="text-center">
                                <p>
                                    <a href="assets/images/gallery/gallery7.jpg" class="gallery-detail-icon" data-lightbox="gallery-images"><i class="fa fa-search"></i></a>
                                    <a href="#" class="gallery-detail-icon"><i class="fa fa-expand"></i></a>
                                </p>
                                <h4 class="gallery-item-heading">HOT PEPPERONI</h4>
                                pizza, salads, design
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 gallery-item filter-hamburgers filter-wordpress">
                        <img alt="photo" src="assets/images/gallery/gallery8.jpg">
                        <div class="gallery-item-detail">
                            <div class="text-right">
                                <a href="assets/images/gallery/gallery8.jpg" class="gallery-detail-icon" data-lightbox="gallery-images"><i class="fa fa-search"></i></a>
                                <a href="#" class="gallery-detail-icon"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div><!-- .gallery-item -->
            ...
            <p class="text-center">
                <a href="gallery_1.html" class="button-yellow with-right-arrow onscroll-animate" data-animation="flipInY">See full gallery</a>
            </p>
        </div><!-- .container -->
    ...
    <section id="section-specials">
    	<div class="container">
            <h1 class="bottom-line">Specials</h1>
            <p class="text-center"><em>When gliding by the Bashee isles we emerged at last upon the great South Sea.</em></p>
            
            <ul class="list-tabs onscroll-animate" data-animation="fadeInDown" data-delay="300">
            ...
            <div id="slider-specials-thumbs" class="flexslider flexslider-thumbs">
                <ul class="slides">
                    <li>
                        <img alt="product photo thumbnail" src="assets/images/slider2/1_small.jpg">
                    </li>
                    <li>
                        <img alt="product photo thumbnail" src="assets/images/slider2/2_small.jpg">
                    </li>
                    <li>
                        <img alt="product photo thumbnail" src="assets/images/slider2/3_small.jpg">
                    </li>
                    <li>
                        <img alt="product photo thumbnail" src="assets/images/slider2/4_small.jpg">
                    </li>
                    <li>
                        <img alt="product photo thumbnail" src="assets/images/slider2/5_small.jpg">
                    </li>
                </ul>
    ...
    <section class="bg-white bg-pattern">
        ...
        <div class="container">
            <div class="row centered-columns">
                <div class="col-md-6 centered-column responsive-column onscroll-animate" data-animation="fadeInLeft">
                    <img class="img-responsive" alt="mobile" src="assets/images/mobile.png">
                </div>
                <div class="col-md-6 centered-column responsive-column onscroll-animate" data-animation="fadeInRight">
                    ...
                    <a href="#" class="onscroll-animate" data-delay="300"><img class="btn-store" alt="app store" src="assets/images/mobile_button1.png"></a>
                    <a href="#" class="onscroll-animate" data-delay="400"><img class="btn-store" alt="google play" src="assets/images/mobile_button2.png"></a>
                    <div class="margin-10"></div>
                </div>
            </div>
        </div><!-- .container -->
    ...
    <section id="section-delivery">
    	<div class="container">
            ...
            <p class="text-center"><em>When gliding by the Bashee isles we emerged at last upon the great South Sea.</em></p>
            <h3 class="text-center text-uppercase">Enter the address where you want the order delivered</h3>
            <form class="text-center">
            	<div class="row onscroll-animate" data-animate="fadeInUp">
                	<div class="col-sm-6">
            			<input type="text" name="email" placeholder="Enter Street Address">
                	</div>
                    <div class="col-sm-6">
            			<input type="text" name="room" placeholder="Apartment, Suite or Room">
                	</div>
                </div>
            	<div class="row onscroll-animate" data-animate="fadeInUp">
                	<div class="col-sm-6">
                ...
                <div class="margin-30"></div>
            	<a class="button-yellow button-long with-right-arrow form-submit-trigger onscroll-animate" data-animation="flipInY">MAKE YOUR ORDER</a>
            </form>
            <div class="section-delimiter"></div>
            <form class="text-center">
                ...
                <input class="button-yellow button-long onscroll-animate" data-animation="flipInY" type="submit" value="Sign in">
                <p class="text-center">
    ...
    <section class="heavy-borders section-socials bg-black-cover3 parallax-background">
    	<div class="margin-50"></div>
    	<div class="container">
        	<p class="text-high">
            	Connect with us Socially and share the Experience
            </p>
            <div class="row text-center">
            	<div class="col-sm-12-5">
                    <a href="#" class="onscroll-animate" data-animation="fadeInUp">
                        <article class="social-big">
                            <div class="social-icon">
                                <i class="fa fa-facebook"></i>
                            </div>
                            Facebook<br>
                            <span class="social-detail">Connect with us</span>
                        </article>
                    </a>
        		</div>
            	<div class="col-sm-12-5">
                    <a href="#" class="onscroll-animate" data-animation="fadeInUp" data-delay="250">
                        <article class="social-big">
                            <div class="social-icon">
            	...
            	<div class="col-sm-12-5">
                    <a href="#" class="onscroll-animate" data-animation="fadeInUp" data-delay="300">
                        <article class="social-big">
                            <div class="social-icon">
            	...
            	<div class="col-sm-12-5">
                    <a href="#" class="onscroll-animate" data-animation="fadeInUp" data-delay="350">
                        <article class="social-big">
                            <div class="social-icon">
            	...
            	<div class="col-sm-12-5">
                    <a href="#" class="onscroll-animate" data-animation="fadeInUp" data-delay="400">
                        <article class="social-big">
                            <div class="social-icon">
    ...
    <section id="section-blog">
    	<div class="container">
        	<h1 class="bottom-line">Latest Blog Posts</h1>
            <p class="text-center"><em>When gliding by the Bashee isles we emerged at last upon the great South Sea.</em></p>
            <div class="row">
            	<div class="col-md-4">
                	<article class="post-preview onscroll-animate" data-animation="fadeInLeft">
                    	<a href="assets/images/blog/post1.jpg" data-lightbox="blog-post1"><img class="post-img" alt="blog post" src="assets/images/blog/post1.jpg"></a>
                        <div class="post-content">
                            <h2 class="post-heading">Pizza Delivery!</h2>
                            <p class="post-meta">
                            	by <a href="#">Chef</a>
                                <span class="delimiter-inline">/</span>
                                on <a href="#">25-05-15</a>
                                <span class="delimiter-inline">/</span>
                                <a href="#">15 Comments</a>
                            </p>
                            <p>
                            	This latter alternative is always permissible, therefore I could have used my short-sword, my dagger, my hatchet, or my fists had I wished.
                            </p>
                            <a href="#" class="button-void-alt button-low">Read More</a>
                    	</div>
                    </article>
              	</div>
            	<div class="col-md-4">
                	<article class="post-preview onscroll-animate" data-animation="fadeInUp" data-delay="300">
                    	<a href="assets/images/blog/post2.jpg" data-lightbox="blog-post2"><img class="post-img" alt="blog post" src="assets/images/blog/post2.jpg"></a>
                        <div class="post-content">
                            <h2 class="post-heading">Blogs Posts for Restaurant</h2>
                            <p class="post-meta">
                            	by <a href="#">Chef</a>
                                <span class="delimiter-inline">/</span>
                                on <a href="#">25-05-15</a>
            	...
            	<div class="col-md-4">
                	<article class="post-preview onscroll-animate" data-animation="fadeInRight" data-delay="300">
                    	<a href="assets/images/blog/post3.jpg" data-lightbox="blog-post3"><img class="post-img" alt="blog post" src="assets/images/blog/post3.jpg"></a>
                        <div class="post-content">
                            <h2 class="post-heading">Baking Great Meals</h2>
                            <p class="post-meta">
                            	by <a href="#">Chef</a>
                                <span class="delimiter-inline">/</span>
                                on <a href="#">25-05-15</a>
            ...
            <div class="text-center">
            	<a href="blog.html" class="button-yellow button-long with-right-arrow onscroll-animate" data-animation="flipInY">SEE ALL BLOG POSTS</a>
			</div>
            <div class="margin-20"></div>
        </div><!-- .container -->
    ...
    <section id="section-contact">
    	<div class="container">
        	<h1 class="bottom-line">Contact Form</h1>
            <p class="text-center"><em>When gliding by the Bashee isles we emerged at last upon the great South Sea.</em></p>
            <div class="margin-40"></div>
            <div class="row">
            	<div class="col-md-7 responsive-column onscroll-animate" data-animation="fadeInUp">
                	<a href="assets/images/store/3.jpg" data-lightbox="store-images"><img class="img-full" alt="store photo" src="assets/images/store/3.jpg"></a>
                    <div class="margin-30"></div>
                    <div class="row">
                    	<div class="col-xs-7">
                        	<a href="assets/images/store/1.jpg" data-lightbox="store-images"><img class="img-full" alt="store photo" src="assets/images/store/1.jpg"></a>
                        </div>
                        <div class="col-xs-5">
                        	<a href="assets/images/store/2.jpg" data-lightbox="store-images"><img class="img-full" alt="store photo" src="assets/images/store/2.jpg"></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-5 responsive-column onscroll-animate" data-animation="fadeInUp" data-delay="350">
                	<h2 class="no-top-margin">Leave a Message for us</h2>
