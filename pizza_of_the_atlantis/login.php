...
<body>
    ...
    <section>
        <div class="container">
            ...
            <p class="text-center"><em><!-- Register yourself to be updated about our regular deals, stuff and other discounts. --></em></p>
            <p class="text-center">Sign in to quickly access addresses saved to your account.</p>
        <div class="row">
            <div class="col-md-12">
            <form class="text-center" action="php/loginmain.php" method="post">
                ...
                <div class="row">
                <!-- <div class="col-md-12">
                <span>Name: <input type="text" name="name" placeholder="Enter Your Name"></span>
                </div> -->
                ...
                <!-- <div class="col-md-6">
                <span>Confirm Password: <input type="password" name="cpassword" placeholder="Retype The Password"></span>
                </div> -->
                <div class="col-md-12">
                    <center>
                    <input class="button-yellow button-heavy" type="submit" name="login" value="Sign In"></center>
                </div>
                <div class="col-md-12">
                    <span style="color: white">Dont have an account ? <a href="signup.php">Register</a></span>
                </div>
                </div>
                </div>
                    <br>                
