...
$con->query("UPDATE information SET views = views + 1");
...
<body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12" style="text-align: center;">
                   <h1 style="color: orange; text-transform: uppercase;"><br>We provide best ambiance, delicious taste, and perfect service !</h1>
                </div>
            </div>

            <div id="product-slider" class="owl-pagination-dash owl-navigation-box">
                <div class="offer">
                    <img alt="product" src="assets/images/slider/4.jpg">
                ...
                <div class="offer">
                    <img alt="product" src="assets/images/slider/5.jpg">
                    <!--<div class="offer-price-small">
                    	$<span class="offer-price-val1">7</span><span class="offer-price-val2">99</span>
                    </div>
                    <div class="offer-detail"> -->
                ...
                <div class="offer">
                    <img alt="product" src="assets/images/slider/6.jpg">
                    <!--<div class="offer-price-small">
                    	$<span class="offer-price-val1">7</span><span class="offer-price-val2">99</span>
                    </div>
                    <div class="offer-detail">
    ...
    <section>
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12" style="text-align: center;">
                   <h1>Each Ingredient Is Fresh</h1>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 responsive-column">
                            <div class="icon-box">
                                ...
                                Made from pure and fresh dough.
                            </div>
                        </div>
                        <div class="col-md-6 responsive-column">
                            <div class="icon-box">
                                ...
                                <h3 class="bottom-line">Tomato</h3>
                                Red juicy tomatoes are used.
                            </div>
                        </div>
                    </div>
                </div><!-- .col-sm-6 -->
                    ...
                    <div class="row">
                        <div class="col-md-6 responsive-column">
                            <div class="icon-box">
                                ...
                                <h3 class="bottom-line">Mushroom</h3>
                                Good quality mushrooms used.
                            </div>
                        </div>
                        <div class="col-md-6 responsive-column">
                            <div class="icon-box">
