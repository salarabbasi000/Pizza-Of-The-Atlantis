...
<body>
    ...
    <section>
        <div class="container">
            ...
            <p class="text-center"><em>Register now for our new updates and get regular discounts, offers and stuff</em></p>
        <div class="row">
            <div class="col-md-12">
            <form class="text-center" action="php/registermain.php" method="post">
                ...
                <input type="text" name="address" required placeholder="Address Where Your Order Will Get Delivered">
                </div>
                <div class="col-md-6 col-sm-12 col-md-offset-3">
                <input type="text" name="contact" required placeholder="Mobile/Phone No.">
                </div>
                <div class="col-md-3 col-sm-6 col-md-offset-3">
                ...
                <div class="col-md-12">
                    <center>
                    <input class="button-yellow button-heavy" type="submit" name="signup" value="Register"></center>
                </div>
                <div class="col-md-12">
                    <span style="color: white">Already have an account ? <a href="login.php">Sign In</a></span>
                </div>
