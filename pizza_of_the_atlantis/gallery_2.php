...
<body>
    ...
    <div class="page-title-img">
        <img class="img-full" alt="page title img" src="pictures/banners/gallery.jpg">
    ...
    <section>
    	<div class="container">
            ...
            <p class="text-center"><em>Check out some of our mouth watering items.</em>
            </p>
           	<div class="text-center">
                ...
                <ul id="gallery-filter" class="list-filter">
                    ...
                    <li><a class="isotope-filter" data-filter=".filter-starters">Starters</a></li>
                    <li><a class="isotope-filter" data-filter=".filter-breverages">Breverages</a></li>
                </ul>
            </div>
            <div id="gallery" class="gallery row">
                ...
                /*$namelist=array("Veggie Pizza","","","","","","","Coca-Cola","All Breverages","Mirinda","Cheese Roll","Cheesy Garlic Bread","Garlic Bread Roll","Chicken Wings","Chicken Nuggets","Garlic Bread");*/

                    $obj[] = new Gallery("Veggie Pizza","pizza"); 
                    $obj[] = new Gallery("Ranch Pizza","pizza"); 
                    $obj[] = new Gallery("Malai Tikka Pizza","pizza"); 
                    $obj[] = new Gallery("Pepperoni Pizza","pizza");
                    $obj[] = new Gallery("Chicken Fajita","pizza"); 
                    $obj[] = new Gallery("Green Tikka Pizza","pizza"); 
                    $obj[] = new Gallery("Afghan Tikka Pizza","pizza"); 
                    $obj[] = new Gallery("Coca-Cola","breverages");
                    $obj[] = new Gallery("All Breverages","breverages"); 
                    $obj[] = new Gallery("Mirinda","breverages"); 
                    $obj[] = new Gallery("Cheese Roll","starters"); 
                    $obj[] = new Gallery("Cheesy Garlic Bread","starters");
                    $obj[] = new Gallery("Garlic Bread Roll","starters"); 
                    $obj[] = new Gallery("Chicken Wings","starters"); 
                    $obj[] = new Gallery("Chicken Nuggets","starters"); 
                    $obj[] = new Gallery("Garlic Bread","starters");

                    for ($i=0; $i<16 ; $i++) { 
                        # code...
                        if($i<7)
                            $filters="filter-pizza";
                        else if ($i<10)
                            $filters="filter-breverages";
                        else
                            $filters="filter-starters";
                ?>
                <div class="col-md-3 col-sm-6 col-xs-12 gallery-item dark-cover <?php echo $filters; ?>">
                    <img alt="photo" src="pictures/gallery/<?php echo"$i";?>.jpg">
                    <div class="gallery-item-detail">
                        <div class="text-center">
                        	<p>
                                <a href="pictures/gallery/<?php echo"$i";?>.jpg" class="gallery-detail-icon" data-lightbox="gallery-images"><i class="fa fa-search"></i></a>
                                <a href="pictures/gallery/<?php echo"$i";?>.jpg" class="gallery-detail-icon"><i class="fa fa-expand"></i></a>
                            </p>
                            <h4 class="gallery-item-heading"><!-- <?php/* echo "$obj[$i]->getName() <br>"*/; ?> -->HOT PEPPERONI </h4>
                            pizza, salads, design
                        </div>
                    </div>
                </div><!-- .gallery-item -->
