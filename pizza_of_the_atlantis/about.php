...
<body>
    ...
    <div class="page-title-img">
        <img class="img-full" alt="page title img" src="pictures/banners/about.png">
    ...
    <section>
        <div class="container">
            ...
            <p class="text-center"><em>Get to know that who we are ? And how we started ?</em></p>
            <div class="row">
                <div class="col-md-6">
                    <h2>Our History</h2>
                    <p>Since year 2018!<br> Our expert team decided to start their own startup, the pizza outlet with an ambition to provide best, fresh and cheesy pizzas in town. Once eaten, you will visit once more !</p>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-6">
                	<div class="slider-single">
                        ...
                        for ($i=0;$i<3;$i++) { 
                            # code...
                        ?>
                    	<img alt="store" src="pictures/about/amz-interior/<?php echo $i; ?>.jpg">
                	   <?php } ?>
                    </div>
                    <div class="margin-20"></div>
                </div>
                <div class="col-md-6">
                    ...
                    <p>Our sweeping staff is trained to keep the interior neat and clean. Even our chefs are trained to do so while making delicious and yummy recipes, as fresh and washed ingedients are used. Thus, we provide a complete hygenic environment.</p>
                </div>
   			</div>
       	</div>
    </section>
                            ...
                            <div class="worker">
                            	<div class="worker-head">
                                        ...
                                        <div class="worker-img-layer-1">
                                            <div class="worker-img-layer-2">
                                                <div class="worker-img-content">
                                                    <img alt="worker" src="<?php echo substr($objarr[$i]->getImage(),3);?>">
                                                    <div class="worker-socials">
                                                    	<div class="worker-socials-content">
                                                            <a href="<?php echo $objarr[$i]->getFb(); ?>" target="_blank">
                                                                <i class="fa fa-facebook"></i></a>
                                                            <a href="<?php echo $objarr[$i]->getInsta(); ?>" target="_blank">
                                    ...
                                    <div class="worker-label">
                                        <h4><?php echo $objarr[$i]->getName(); ?></h4>
                                        <em><?php echo $objarr[$i]->getPosition(); ?></em>
                                    </div>
                            	</div><!-- .worker-head -->
                                <p class="worker-note">
                                    <!-- When gliding by the Bashee isles we emerged at last upon the great South Sea. -->
                                    <?php echo $objarr[$i]->getDescription(); ?>
                                </p>
                            </div><!-- .worker -->
                        </div><!-- .col-sm-6 -->
                        <?php
